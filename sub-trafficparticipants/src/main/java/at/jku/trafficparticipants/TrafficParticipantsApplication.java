package at.jku.trafficparticipants;

import at.jku.trafficparticipants.demo.Calculator;
...
@ApplicationPath("/trafficparticipants")
@ApplicationScoped
public class TrafficParticipantsApplication extends Application {
